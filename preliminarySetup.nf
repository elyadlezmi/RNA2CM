...
process createDictionery {
    ...
    input:
    file fasta from Channel.fromPath("$projectDir/data/GRCh38.primary_assembly.genome.fa")
    file index from Channel.fromPath("$projectDir/data/GRCh38.primary_assembly.genome.fa.fai")
...
process indexRenamedVCFs {
        ...
        input:
        file dbSNP from Channel.fromPath("$projectDir/data/dbSNPbuild154Renamed.vcf.gz")
...
//        
//        cpus params.cpu
////        publishDir "$projectDir/data/GRCh", mode: 'copy'
//            
//        input:
...
//        
//        cpus params.cpu
////        publishDir "$projectDir/data/GRCm", mode: 'copy'
//             
//        input:
